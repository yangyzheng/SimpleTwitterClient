...
public class NewTweetActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tvTweetUser.setText(sharedPref.getString("myName", "Me"));
		tvTweetHandle.setText("@"+ sharedPref.getString("myScreenName", "Me"));
		String profileImageUrl = sharedPref.getString("myProfileImageUrl", null);
